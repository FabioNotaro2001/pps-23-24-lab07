...
class ScalaTestParser extends org.scalatest.funsuite.AnyFunSuite:
  ...
  test("Test two non consecutive parser"):
  ...
  test("Test non empty and two non consecutive parser"):
